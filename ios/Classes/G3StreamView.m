...
-(void)initView{
    //init image view
    self.imageView = [[UIImageView alloc] initWithFrame:_view.bounds];
    self.imageView.contentMode = UIViewContentModeScaleAspectFit;
...
//
//    // Add ImageView (logo)
////    UIImageView *logoImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"logo_white"]];
////    logoImageView.translatesAutoresizingMaskIntoConstraints = NO;
////    [linearLayout addSubview:logoImageView];
////
////    // Add layout constraints for logoImageView
////    [NSLayoutConstraint activateConstraints:@[
////        [logoImageView.trailingAnchor constraintEqualToAnchor:linearLayout.trailingAnchor constant:-8],
////        [logoImageView.bottomAnchor constraintEqualToAnchor:linearLayout.bottomAnchor]
////    ]];
//
...
//        [self.metaDataLabel.bottomAnchor constraintEqualToAnchor:linearLayout.bottomAnchor]
//    ]];
}
...
-(void) processFrameData:(NSData*) data {
    NSLog(@"Vo day r ma sao khong hien%d", data.length);
