...
class DashcamPlayerPlugin : FlutterPlugin, MethodCallHandler {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        flutterPluginBinding.getPlatformViewRegistry()
            .registerViewFactory("player", PlayerFactory(this))
        flutterPluginBinding.getPlatformViewRegistry()
            .registerViewFactory("g3_stream", G3StreamFactory(metaDataInStream))
        flutterPluginBinding.getPlatformViewRegistry()
            .registerViewFactory("g3_stream_online", G3StreamOnlineFactory(this))
    }
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
        if (call.method == "getPlatformVersion") {
            ...
            if (exoPlayer != null && position != null) {
                ...
                if (duration > 0) {
                    val seekPosition =
                        (position * duration) // Tính toán vị trí tua dựa trên phần trăm
